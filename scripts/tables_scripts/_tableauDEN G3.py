...
def process_csv_and_show_message():
    try:
        # Load the CSV file
        csv_path = '../results/_tableauDEN G3.csv'  # Replace with the path to your CSV file
        ...
        output_csv_path = '../results/_tableauDEN G3-2.csv'  # Replace with your desired output path
